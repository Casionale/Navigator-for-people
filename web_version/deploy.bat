...
"%PSCP%" -load %SESSION% -r "%APP_DIR%app.py" "%APP_DIR%navigator.py" "%APP_DIR%requirements.txt" "%APP_DIR%CHANGELOG.md" "%APP_DIR%VERSION" "%APP_DIR%.github_token" e621@bakasenpai.ru:%REMOTE_DIR%/
